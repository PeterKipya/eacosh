...
<head>
  ...
  <meta name="google-site-verification" content="rr1Brli7EM0Oiz_8axn0ZpRNFuQis8Wbv2GyQaBMpn4" />
  ...
  <div class="shadow-lg"
    ...
    <div class="container">
        <div class="text-center">
          <p class="text-white" style="font-family: 'Roboto', sans-serif;font-weight: 700;font-size: 40px;">
            <br>
            East Africa Conference on <br>
            <span style="color:#fcca0a;">Occupational Safety & Health<br>
            <span>
          ...
          <hr color="white">
          <p style="font-family: 'Roboto',sans-serif;font-weight: 700;color: white;" class="h3">
            Towards a vision of zero accident in the East Africa Extractives Industry.
            </p>
          <div style="display: flex;flex-direction: row;align-items: center;justify-content: center;">
            <a class="nav-item primary_btn" href="register.php">Register</a>
      ...
      <div class="container align-items-center">
        ...
        <div>
          <h4 style="font-family: 'Roboto', sans-serif;font-weight: 700;text-align: center;">
            The 1<sup>st</sup> EAST AFRICA CONFERENCE ON OCCUPATIONAL SAFETY AND HEALTH
          </h4>
          <br>
          ...
          <blockquote class=" blockquote text-center">
            ...
            <footer class="blockquote-footer">eacosh.com</footer>
          </blockquote>

          <div style="display: flex;flex-direction: row;flex-wrap: wrap;justify-content: center;">

            <div class="stat">
              <span class="statmain">10,000Mwe</span><br>
              <span class="stattext">Kenya's total Geothermal potential</span>
            </div>
            <div class="stat">
              <span class="statmain">777 MWe</span><br>
              <span class="stattext">Current developed Geothermal Capacity</span>
            </div>
            <div class="stat">
              <span class="statmain">5530 Mwe</span><br>
              <span class="stattext">2030 production target </span>
            </div>
          </div>
          ...
          <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 col-xl-12">
            ...
            <script>
              ...
              var countDownDate = new Date("March 17, 2020 08:00:00").getTime();
