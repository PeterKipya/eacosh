    ...
    <div class="bg-white container justify-content-center align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-center flex-wrap ">
            <div class="partner card shadow-sm">
                <img class="partner_logo" width="180px" height="80px;" src="../assets/images/logos/doshiwater.jpg"
                    alt="">
            </div>
            <div class="partner card shadow-sm">
                <img class="partner_logo" width="140px" height="80px;" src="../assets/images/logos/aas.png" alt="">
            ...
            <div class="partner card shadow-sm">
                <img class="partner_logo" width="250px" height="100px;" src="../assets/images/logos/kaeser.png" alt="">
            </div>
        ...
        <div class="container justify-content-center d-flex"> 
            <div class="partner card shadow-sm">
                <img width="200px" src="../assets/images/logos/logo19.gif" alt="">
            </div>
        </div>
        <br>
    </div>
    ...
    <div class="container">
        <div class="d-flex flex-row align-items-center justify-content-center">
            <div class="col-12">
                ...
                <p class="text-center">Tel: +254-728-615-4  38</p>
